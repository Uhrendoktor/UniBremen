...
\begin{document}
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\intertext{Substitution mit $s\coloneqq x^{\frac{1}{6}}\Rightarrow dx=6s^5ds$}
			...
			\intertext{Substitution mit $s_1\coloneqq x-1, s_2\coloneqq x+2, s_3\coloneqq (x+2)^2 \Rightarrow dx=\frac{1}{2\sqrt{s_3}}ds_3$}
