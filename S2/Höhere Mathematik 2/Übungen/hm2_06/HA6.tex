	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{eqnn}
				...
				\eqn[][\Rightarrow]{c}{0}
				\eqn[][\Rightarrow]{x(t)}{v_S\ln(v_Pt+l)(t+\frac{l}{v_P})}
			\end{eqnn}		
			...
			\begin{eqnn}
				\eqnf{x(t)}{p(t)}
				\eqn{v_S\ln(v_Pt+l)(t+\frac{l}{v_P})}{v_Pt+l}
				\eqn{v_S\ln(v_Pt+l)(t+\frac{l}{v_P})}{v_P(t+\frac{l}{v_P})}
				\eqn{v_S\ln(v_Pt+l)}{v_P}
				\eqn{t}{\frac{e^{\frac{v_P}{v_S}}-l}{v_P}}
			\end{eqnn}\\
