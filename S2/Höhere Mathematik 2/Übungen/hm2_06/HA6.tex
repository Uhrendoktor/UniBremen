...
\begin{document}
	\begin{enumerate}
		...
		$$\Rightarrow T(t)=17\left(\frac{8}{17}\right)^{\frac{t}{45}}+6$$
		...
		\begin{enumerate}
			...
			\begin{eqnn}
				...
				\eqntext{Eine Stelle $x, 0\leq x\leq d=p(t)$ auf dem vom Pferd aufgespannten Band besitzt}\\[-25pt]
